...
if(args[0] == "help"){
    ...
    .setDescription("`usage : xx!about info|general|support|promote|market|chill|lf|casual|rank|scrimmageinfo|scrimmage|scrimmageteam`\n**Example : v!about info**")
